...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "vUBvljCsALBHYGZQIOPGkQSBA", consumerSecret: "FkbgrHjRV6PoXo2u3mLmm0GLCoiAy7HRHeDZBJUamOakfQOUo3")
    var loginSuccess: (() -> ())?
